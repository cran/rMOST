...
This document presents the example application of the rMOST package. Please refer to Song et al. (provisionally accepted) for a complete guideline on adopting multi-objective optimization for personnel selection.
